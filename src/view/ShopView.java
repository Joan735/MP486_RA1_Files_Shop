...
public class ShopView extends JFrame implements ActionListener, KeyListener {
	...
	public ShopView() {
		...
		lblShowCash.setBounds(100, 20, 236, 14);
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyChar() == '0') {
			if (shop.writeInventory()) {
				JOptionPane.showMessageDialog(null, "Export successful", "Confirmation",
						JOptionPane.INFORMATION_MESSAGE);
			} else {
				JOptionPane.showMessageDialog(null, "An error occurred during export", "Error",
